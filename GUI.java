...
public abstract class GUI {
	...
	/**
	 * Is called when the mouse wheel is turned, and is passed the
	 * MouseWheelEvent object for that scroll.
	 */
	protected abstract void onScroll(MouseWheelEvent m);

	/**
	 * Is called when a mouse button goes down, facilitates drag and drop
	 */
	...
	// non-private so scaling in JourneyPlanner has access
	public static final int DEFAULT_DRAWING_HEIGHT = 400;
	public static final int DEFAULT_DRAWING_WIDTH = 600;
